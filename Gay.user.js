...
(function () {
  ...
  let _0xH = document.createElement('div'); _0xH.className = 'lux-header'; _0xH.innerHTML = `<div style="display:flex; align-items:center; gap: 8px;"><span style="display:inline-block; width:10px; height:10px; background:#4ade80; border-radius:50%; box-shadow: 0 0 8px #4ade80;"></span><span style="letter-spacing: 0.5px; text-shadow: 0 2px 4px rgba(0,0,0,0.5);">未知用户 TỰ ĐỘNG</span></div><button id="lux-toggle-btn" class="lux-btn" title="Thu nhỏ / Phóng to">−</button>`; _0xP.appendChild(_0xH);
