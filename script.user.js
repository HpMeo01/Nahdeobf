// ==UserScript==
// @name         Auto Earn - CryptoLinkForEarn
// @namespace    auto_earn
// @version      1.0
...
#ae-panel {
    ...
    background: rgba(10,10,20,0.95); border: 1px solid rgba(168,85,247,0.5);
...
#ae-panel .ae-log { color: #94a3b8; font-size: 11px; margin-top: 4px; max-height: 80px; overflow-y: auto; }
#ae-panel .ae-btn {
    margin-top: 8px; padding: 4px 10px; border-radius: 5px; border: none; cursor: pointer;
...
function createPanel() {
    ...
    panel.id = 'ae-panel';
    panel.innerHTML = `
        <div class="ae-title">⚡ Auto Earn</div>
...
async function main() {
    ...
    } else if (host.includes('linkhuongdan.online')) {
